...
Mac Smooth Scroll 0.4.0 Preview requires an Apple Silicon Mac running macOS 13
or later.
...
3. Open `Mac-Smooth-Scroll-0.4.0-arm64.dmg`.
...
```sh
shasum -a 256 -c Mac-Smooth-Scroll-0.4.0-arm64.dmg.sha256
```
