...
- Use **Minimum wheel step** to set the minimum point distance generated by
  each discrete wheel input. Lower values favor precision; higher values move
  farther per notch. The range remains `0.01–100.00 pt`, the default is
  `18.00 pt`, and the slider supports arrow keys and VoiceOver adjustment.
